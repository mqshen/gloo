...
type HttpListenerOptions struct {
	...
	Oauth *v31.CsrfPolicy `protobuf:"bytes,16,opt,name=oauth,proto3" json:"oauth,omitempty"`
}
...
func (x *HttpListenerOptions) GetOauth() *v31.CsrfPolicy {
	if x != nil {
		return x.Oauth
	}
	return nil
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_rawDesc = []byte{
	...
	0x72, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xf2, 0x09, 0x0a, 0x13,
	...
	0x4f, 0x0a, 0x05, 0x6f, 0x61, 0x75, 0x74, 0x68, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39,
	...
	0x73, 0x72, 0x66, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x05, 0x6f, 0x61, 0x75, 0x74, 0x68,
	...
	0x6a, 0x77, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xb8, 0x11, 0x0a, 0x0c, 0x52,
	...
	0x65, 0x6e, 0x76, 0x6f, 0x79, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x59, 0x0a,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_depIdxs = []int32{
	...
	22, // 18: gloo.solo.io.HttpListenerOptions.oauth:type_name -> solo.io.envoy.extensions.filters.http.csrf.v3.CsrfPolicy
	...
	51, // 66: gloo.solo.io.DestinationSpec.aws:type_name -> aws.options.gloo.solo.io.DestinationSpec
	52, // 67: gloo.solo.io.DestinationSpec.azure:type_name -> azure.options.gloo.solo.io.DestinationSpec
	53, // 68: gloo.solo.io.DestinationSpec.rest:type_name -> rest.options.gloo.solo.io.DestinationSpec
	54, // 69: gloo.solo.io.DestinationSpec.grpc:type_name -> grpc.options.gloo.solo.io.DestinationSpec
	...
	55, // 77: gloo.solo.io.RouteOptions.EnvoyMetadataEntry.value:type_name -> google.protobuf.Struct
