...
type AccessTokenValidation struct {
	...
	//	*AccessTokenValidation_MatchPredicate
...
func (x *AccessTokenValidation) GetMatchPredicate() string {
	if x, ok := x.GetScopeValidation().(*AccessTokenValidation_MatchPredicate); ok {
		return x.MatchPredicate
	}
	return ""
}
...
type AccessTokenValidation_MatchPredicate struct {
	// Require token to have scopes satisfying the given boolean expression.
	// Examples:
	// scope1 && scope2 : must have both "scope1" and "scope2"
	// scope1 || scope2 : must have either "scope1" or "scope2"
	// !scope1 && (scope2 || scope3)  : must not have "scope1" and must have either "scope2" or "scope3"
	MatchPredicate string `protobuf:"bytes,7,opt,name=match_predicate,json=matchPredicate,proto3,oneof"`
}

func (*AccessTokenValidation_MatchAll) isAccessTokenValidation_ScopeValidation() {}

func (*AccessTokenValidation_MatchPredicate) isAccessTokenValidation_ScopeValidation() {}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x57, 0x0a, 0x09, 0x6d, 0x61,
	0x74, 0x63, 0x68, 0x5f, 0x61, 0x6c, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e,
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e,
	...
	0x6f, 0x70, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x01, 0x52, 0x08, 0x6d, 0x61, 0x74, 0x63, 0x68,
	0x41, 0x6c, 0x6c, 0x12, 0x29, 0x0a, 0x0f, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x70, 0x72, 0x65,
	0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x0e,
	0x6d, 0x61, 0x74, 0x63, 0x68, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x1a, 0x21,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_goTypes = []interface{}{
	...
	(*AccessTokenValidation_ScopeList)(nil), // 37: enterprise.gloo.solo.io.AccessTokenValidation.ScopeList
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_depIdxs = []int32{
	...
	59, // 22: enterprise.gloo.solo.io.OidcAuthorizationCode.client_secret_ref:type_name -> core.solo.io.ResourceRef
	...
	60, // 27: enterprise.gloo.solo.io.AccessTokenValidation.cache_timeout:type_name -> google.protobuf.Duration
	37, // 28: enterprise.gloo.solo.io.AccessTokenValidation.match_all:type_name -> enterprise.gloo.solo.io.AccessTokenValidation.ScopeList
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_msgTypes[15].OneofWrappers = []interface{}{
		...
		(*AccessTokenValidation_MatchPredicate)(nil),
	}
